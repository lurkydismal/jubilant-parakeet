...
struct pcre {
    ...
    static constexpr auto rule( s, ctll::term< '\x28' > )
        -> ctll::push< ctll::anything,
                       ...
                       string2,
                       content2 >;
    static constexpr auto rule( s, ctll::term< '^' > ) -> ctll::
    ...
    static constexpr auto rule( s, _others ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( s, ctll::term< '.' > )
        -> ctll::push< ctll::anything,
                       ...
                       content2 >;
    static constexpr auto rule( s, ctll::term< '|' > ) -> ctll::
        push< ctll::anything, push_empty, opt_content, make_alternate >;
    ...
    static constexpr auto rule( a, ctll::term< '\\' > )
        -> ctll::push< ctll::anything,
                       ...
                       content2,
                       make_alternate >;
    static constexpr auto rule( a, ctll::term< '[' > ) -> ctll::
    ...
    static constexpr auto rule( c, _others ) -> ctll::push< ctll::anything,
                                                            ...
                                                            set_make,
                                                            ctll::term< ']' > >;
    static constexpr auto rule( c, ctll::term< '^' > ) -> ctll::
    ...
    static constexpr auto rule( content2, ctll::term< '\x29' > )
        -> ctll::epsilon;
    ...
    static constexpr auto rule( content_in_capture,
                                ctll::set< '!',
                                           ...
                                           'z' > ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( content_in_capture, _others ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( content_in_capture, ctll::term< '.' > )
        -> ctll::push< ctll::anything,
                       push_character_anything,
    ...
    static constexpr auto rule( content_in_capture,
                                ctll::term< '|' > ) -> ctll::
        push< ctll::anything, push_empty, content_or_empty, make_alternate >;
    ...
    static constexpr auto rule( content_or_empty, ctll::term< '\x28' > )
        -> ctll::push< ctll::anything,
                       ...
                       string2,
                       content2 >;
    static constexpr auto rule( content_or_empty, ctll::term< '^' > ) -> ctll::
        push< ctll::anything, push_assert_begin, repeat, string2, content2 >;
    static constexpr auto rule( content_or_empty, ctll::term< '$' > ) -> ctll::
        push< ctll::anything, push_assert_end, repeat, string2, content2 >;
    static constexpr auto rule( content_or_empty,
                                ctll::set< '!',
                                           ...
                                           'z' > ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( content_or_empty, _others ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( content_or_empty, ctll::term< '.' > )
        -> ctll::push< ctll::anything,
                       push_character_anything,
                       ...
                       string2,
                       content2 >;
    static constexpr auto rule( content_or_empty, ctll::term< '\x29' > )
        -> ctll::push< push_empty >;
    static constexpr auto rule(
        content_or_empty,
        ctll::set< '*', '+', '?', '\x7B', '|', '\x7D' > ) -> ctll::reject;
    ...
    static constexpr auto rule( i, ctll::term< 'g' > )
        -> ctll::push< ctll::anything,
                       ...
                       ctll::term< ':' >,
                       ctll::term< ']' > >;
    static constexpr auto rule( i, ctll::term< 'a' > ) -> ctll::
        push< ctll::anything, g, ctll::term< ':' >, ctll::term< ']' > >;
    static constexpr auto rule( i, ctll::term< 'p' > ) -> ctll::
        push< ctll::anything, h, ctll::term< ':' >, ctll::term< ']' > >;
    ...
    static constexpr auto rule( opt_content, ctll::term< '\x28' > )
        -> ctll::push< ctll::anything,
                       ...
                       string2,
                       content2 >;
    static constexpr auto rule( opt_content, ctll::term< '^' > ) -> ctll::
        push< ctll::anything, push_assert_begin, repeat, string2, content2 >;
    static constexpr auto rule( opt_content, ctll::term< '$' > ) -> ctll::
        push< ctll::anything, push_assert_end, repeat, string2, content2 >;
    static constexpr auto rule( opt_content,
                                ctll::set< '!',
                                           ...
                                           'z' > ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( opt_content, _others ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, content2 >;
    static constexpr auto rule( opt_content, ctll::term< '.' > )
        -> ctll::push< ctll::anything,
                       push_character_anything,
                       ...
                       string2,
                       content2 >;
    static constexpr auto rule( opt_content, ctll::epsilon )
        -> ctll::push< push_empty >;
    static constexpr auto rule(
        opt_content,
    ...
    static constexpr auto rule( set2a, ctll::term< '[' > ) -> ctll::
    ...
    static constexpr auto rule( set2a,
                                ctll::set< '!',
                                           ...
                                           '|',
                                           '\x7D' > ) -> ctll::
        push< ctll::anything, push_character, range, set_start, set2b >;
    static constexpr auto rule( set2a, _others ) -> ctll::
        push< ctll::anything, push_character, range, set_start, set2b >;
    static constexpr auto rule( set2a, ctll::term< ']' > )
        -> ctll::push< set_empty >;
    ...
    static constexpr auto rule( set2b, ctll::term< '[' > ) -> ctll::
    ...
    static constexpr auto rule( set2b, _others ) -> ctll::
        push< ctll::anything, push_character, range, set_combine, set2b >;
    ...
    static constexpr auto rule( string2, ctll::term< '\\' > ) -> ctll::
    ...
    static constexpr auto rule( string2, ctll::term< '^' > )
        -> ctll::push< ctll::anything,
                       ...
                       make_sequence >;
    static constexpr auto rule( string2, ctll::term< '$' > ) -> ctll::
        push< ctll::anything, push_assert_end, repeat, string2, make_sequence >;
    ...
    static constexpr auto rule( string2, _others ) -> ctll::
        push< ctll::anything, push_character, repeat, string2, make_sequence >;
    static constexpr auto rule( string2, ctll::term< '.' > )
        -> ctll::push< ctll::anything,
                       push_character_anything,
