...
auto convert_to_capture( ctll::list< Content... > )
...
template < template < size_t, size_t, typename... > typename CycleType,
           ...
           size_t B,
           typename... Content >
auto convert_to_repeat( ctll::list< Content... > )
    -> CycleType< A, B, Content... >;
template < template < typename... > typename ListType, typename... Content >
auto convert_to_basic_list( ctll::list< Content... > )
    -> ListType< Content... >;
...
struct rotate_for_lookbehind {
    ...
    static auto rotate( negative_set< Content... > )
        -> negative_set< Content... >;
    template < typename... Content >
    ...
    static auto rotate( binary_property< T, Type > )
        -> binary_property< T, Type >;
    template < typename T, T Type, auto Value >
    static auto rotate( property< T, Type, Value > )
        -> property< T, Type, Value >;
    ...
    static auto rotate( repeat< a, b, Content... > )
        -> decltype( ctre::convert_to_repeat< repeat, a, b >( ctll::rotate(
            ctll::list< decltype( rotate( Content{} ) )... >{} ) ) );
    template < size_t a, size_t b, typename... Content >
    static auto rotate( lazy_repeat< a, b, Content... > )
        -> decltype( ctre::convert_to_repeat< lazy_repeat, a, b >( ctll::rotate(
            ctll::list< decltype( rotate( Content{} ) )... >{} ) ) );
    template < size_t a, size_t b, typename... Content >
    ...
    static auto rotate( capture< Index, Content... > ) {
        return ctre::convert_to_capture< Index >( ctll::rotate(
            ctll::list< decltype( rotate( Content{} ) )... >{} ) );
    }

    template < size_t Index, typename Name, typename... Content >
    static auto rotate( capture_with_name< Index, Name, Content... > ) {
        return ctre::convert_to_named_capture< Index, Name >( ctll::rotate(
            ctll::list< decltype( rotate( Content{} ) )... >{} ) );
    }
    ...
    static auto rotate( sequence< Content... > ) {
        return ctre::convert_to_basic_list< sequence >( ctll::rotate(
            ctll::list< decltype( rotate( Content{} ) )... >{} ) );
    }
    ...
    static auto rotate( atomic_group< Content... > ) {
        return ctre::convert_to_basic_list< atomic_group >( ctll::rotate(
            ctll::list< decltype( rotate( Content{} ) )... >{} ) );
    }
    ...
    template < typename... Content >
    static auto rotate( not_boundary< Content... > )
        -> not_boundary< Content... >;
